...
// type StringToUnion<T extends string, A extends string = ''> = T extends "" ? never :
//     T extends `${infer F}${infer R}` ? R extends '' ? A extends '' ? F : A | F : StringToUnion<R, A extends '' ? F : A | F> : A;
