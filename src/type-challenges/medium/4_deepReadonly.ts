...
//
// type DeepReadonly<T extends object> = {
//     readonly [P in keyof T]: keyof T[P] extends never ? T[P] : T[P] extends object ? DeepReadonly<T[P]> : T[P]
// }
// type DeepReadonly<T> = { readonly [P in keyof T]: T[P] extends {[ x: number]: unknown} ? DeepReadonly<T[P]>: T[P] };

type DeepReadonly<T> = { readonly [P in keyof T]: T[P] extends Record<number, unknown> ? DeepReadonly<T[P]> : T[P] };
